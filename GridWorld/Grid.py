...
class GridClass:
    ...
    def __init__(self):
        ...
        self.ally1 = Ally.AllyRobotClass(650, 0, self.grid_ui_obj, "1")
        self.ally2 = Ally.AllyRobotClass(0, 700, self.grid_ui_obj, "2")
        self.ally3 = Ally.AllyRobotClass(1300, 700, self.grid_ui_obj, "3")
